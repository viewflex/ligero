...
//        return array_key_exists('view', $params) ? $params['view'] : 'default';
    ...
    */
     ...
     * @return string
     */
    protected function urlSelfQueryString()
    {
        $skip = [
            'action',
            'items',
     ...
     * @return array
     */
    protected function getUrlDisplayParameters($config = [], $base_params = [])
    {
        $display_params = [];
     ...
     * @return array
     */
    protected function getNavUrlBaseParameters() {
     ...
     * @return int
     */
    protected function numPages($found = 0, $limit = 1, $start = 0)
    {
     ...
     * @return int
     */
    protected function logicalPage($start = 0) {
     ...
     * @return int
     */
    protected function relativePage($start = 0) {
     ...
     * @return array
     */
    protected function viewMenu($context = 'fresh')
    {
        $view = $this->getQueryView();
        $limit = $this->getQueryLimit();
        $start = $this->getQueryStart();
