...
class Publisher implements PublisherInterface
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        switch ($num_args) {
            case 1: { // take given api instance and use it's config and request
            ...
            case 2: { // make new api instance from given config and request
            ...
            case 3: { // make new api instance from given config, request, and query
                $this->config = func_get_arg(0);
                $this->request = func_get_arg(1);
    ...
    */
    ...
    /**
     * Get info on API query and results.
     *
     * @return array
     */
